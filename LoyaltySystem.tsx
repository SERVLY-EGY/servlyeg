...
import { ArrowLeft, Users, Gift, TrendingUp, Star, Plus, Eye, CreditCard as Edit, Trash2, Download, Copy, Smartphone, QrCode, Settings, BarChart3, Award, Target, Zap, CreditCard, Calendar, Clock, DollarSign, UserPlus, X } from 'lucide-react';
...
const LoyaltySystem: React.FC<LoyaltySystemProps> = ({ onBack }) => {
  ...
  const [storeSettings, setStoreSettings] = useState({
    ...
    minimumRedeem: 100,
    levels: {
      bronze: { min: 0, max: 999, name: 'برونزي', color: '#CD7F32' },
  ...
  const AddCustomerModal = () => (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="backdrop-blur-xl bg-white/95 rounded-3xl border border-white/20 shadow-xl p-8 max-w-2xl w-full mx-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setNewCustomer(prev => ({ ...prev, initialPoints: parseInt(e.target.value) || 0 }))}
                className="w-full px-4 py-3 rounded-xl bg-white/60 border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
                placeholder="0"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewCustomer(prev => ({ ...prev, cardColor: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewCustomer(prev => ({ ...prev, textColor: e.target.value }))}
                  className="w-full h-12 rounded-xl cursor-pointer border-2 border-gray-200"
                />
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <select
              ...
              onChange={(e) => setPointsData(prev => ({ ...prev, customerId: e.target.value }))}
              className="w-full px-4 py-3 rounded-xl bg-white/60 border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
            >
          ...
          <div className="flex mb-4 bg-gray-100 rounded-xl p-1">
            <button
              onClick={() => setPointsData(prev => ({ ...prev, type: 'purchase' }))}
            ...
            <button
              onClick={() => setPointsData(prev => ({ ...prev, type: 'manual' }))}
              className={`flex-1 py-2 px-3 text-sm font-medium rounded-lg transition-colors ${
                pointsData.type === 'manual'
                  ? 'bg-white text-gray-900 shadow-sm'
                  : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (selectedReward) {
                    ...
                    setNewReward(prev => ({ ...prev, pointsRequired: points }));
                  }
                }}
                className="w-full px-4 py-3 rounded-xl bg-white/60 border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
                placeholder="500"
              ...
              <select
                ...
                onChange={(e) => {
                  if (selectedReward) {
                    ...
                    setNewReward(prev => ({ ...prev, category: e.target.value }));
                  }
                }}
                className="w-full px-4 py-3 rounded-xl bg-white/60 border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
              >
            ...
            <input
              ...
              onChange={(e) => {
                if (selectedReward) {
                  ...
                  setNewReward(prev => ({ ...prev, image: e.target.value }));
                }
              }}
              className="w-full px-4 py-3 rounded-xl bg-white/60 border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
  ...
  const ReportsModal = () => {
    ...
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="backdrop-blur-xl bg-white/95 rounded-3xl border border-white/20 shadow-xl p-8 max-w-6xl w-full mx-4 max-h-[90vh] overflow-y-auto">
          <div className="flex items-center justify-between mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* إحصائيات إضافية */}
            <div className="bg-white/60 rounded-2xl p-6 border border-gray-200">
              <h4 className="text-lg font-bold text-gray-900 mb-4">إحصائيات إضافية</h4>
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-gray-600">متوسط النقاط لكل عميل</span>
                  <span className="font-bold">{averagePoints}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">متوسط الإنفاق لكل عميل</span>
                  <span className="font-bold">{totalCustomers > 0 ? Math.round(totalSpent / totalCustomers) : 0} ر.س</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">معدل النقاط لكل ريال</span>
                  <span className="font-bold">{storeSettings.pointsPerRiyal}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">الحد الأدنى للاستبدال</span>
                  <span className="font-bold">{storeSettings.minimumRedeem} نقطة</span>
                </div>
              </div>
            </div>
          </div>
